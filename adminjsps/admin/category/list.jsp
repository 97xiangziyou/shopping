    ...
    <c:forEach items="${parents }" var="parent">	
    	<tr class="trOneLevel">
    		...
    		<td width="200px;">
    		  ...
    		  <a onclick="return confirm('您是否真要删除该一级分类？')" href="<c:url value="/admin/AdminCategoryServlet?method=deleteOne&cid=${child.cid }"/>">删除</a>
    		</td>
    	</tr>
    	...
    	<tr class="trTwoLevel">
    		...
    		<td width="200px;" align="right">
    		  ...
    		  <a onclick="return confirm('您是否真要删除该二级分类？')" href="<c:url value="/admin/AdminCategoryServlet?method=deleteTwo&cid=${child.cid }"/>">删除</a>
    		</td>
    	</tr>
   </c:forEach>
    	</c:forEach>
